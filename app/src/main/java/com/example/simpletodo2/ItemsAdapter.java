...
//Responsible for displaying data from the model into a row in recycle view
public class ItemsAdapter extends RecyclerView.Adapter<ItemsAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //Use layout inflater to inflate a new view
        ...
        public void bind(String item) {
            ...
            tvItem.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    //Remove the item from the recycler view XXXXXXXX
                    //Actually: notify listener with which item was long pressed
